...
class TrainSms {
    ...
    static List<Map<String, String>> getTrainedListOfSms(Context context, List<Map<String, String>> smsListToTrain, List<Map<String, String>> smsListToTrainAgainst) {
    ...
    static List<Map<String, String>> retrainExistingSms(Context context, Map<String, String> trainedSms, List<Map<String, String>> allSms) {
        ...
        for (Map<String, String> toTrainSmsMap : cleanedAllSms) {
            ...
            double highestSimScore = Double.parseDouble(toTrainSmsMap.get(DatabaseContract.Sms.KEY_SIM_SCORE));
